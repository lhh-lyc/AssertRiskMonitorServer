package com.lhh.serverReScan.config;
...
public class RabbitMqConfig {
    ...
    @Value("${mqtt-setting.reSubDomain-pub-topic}")
    private String reSubDomainPubTopic;
    ...
    @Bean
    public Queue queueA() {
        return new Queue(reSubDomainRouteKey, true); //队列持久：不会随着服务器重启造成丢失
    }
    ...
    public Binding binding() {
        //绑定队列到交换机上通过路由
        return BindingBuilder.bind(queueA()).to(defaultExchange()).with(reSubDomainPubTopic);
    }
